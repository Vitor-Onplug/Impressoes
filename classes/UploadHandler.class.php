 ...
 * https://github.com/blueimp/j*Query-File-Upload
 *
...
class UploadHandler
{
    ...
    protected function get_file_name(
        ...
        // Adicionar data no início do nome
        $dataAtual = date('Y-m-d_H-i-s_');
    ...
    protected function handle_image_file($file_path, $file)
    {
        ...
        if (!empty($failed_versions)) {
            $file->error = $this->get_error_message('image_resize')
                . ' (' . implode(', ', $failed_versions) . ')'; // Corrigido a ordem dos argumentos
        }
        // Free memory:
        $this->destroy_image_object($file_path);
    }
