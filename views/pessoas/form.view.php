		...
		<div class="row">
			<div class="col-lg-2 col-xs-2">
				<div class="small-box <?php if (chk_array($this->parametros, 0) == 'adicionar') {
											echo "bg-red";
										} elseif (chk_array($this->parametros, 0) == 'editar' && (chk_array($this->parametros, 2) != 'documentos' && chk_array($this->parametros, 2) != 'emails' && chk_array($this->parametros, 2) != 'enderecos' && chk_array($this->parametros, 2) != 'telefones' && chk_array($this->parametros, 2) != 'arquivos')) {
											echo "bg-red";
										} else {
											echo "bg-gray";
										} ?>">
			...
			<div class="col-lg-2 col-xs-2">
				<div class="small-box <?php if (chk_array($this->parametros, 0) == 'adicionar') {
											echo "bg-gray";
										} elseif (chk_array($this->parametros, 0) == 'editar' && chk_array($this->parametros, 2) == 'documentos') {
											echo "bg-red";
										} else {
											echo "bg-gray";
										} ?>">
			...
			<div class="col-lg-2 col-xs-2">
				<div class="small-box <?php if (chk_array($this->parametros, 0) == 'adicionar') {
											echo "bg-gray";
										} elseif (chk_array($this->parametros, 0) == 'editar' && chk_array($this->parametros, 2) == 'emails') {
											echo "bg-red";
										} else {
											echo "bg-gray";
										} ?>">
			...
			<div class="col-lg-2 col-xs-2">
				<div class="small-box <?php if (chk_array($this->parametros, 0) == 'adicionar') {
											echo "bg-gray";
										} elseif (chk_array($this->parametros, 0) == 'editar' && chk_array($this->parametros, 2) == 'enderecos') {
											echo "bg-red";
										} else {
											echo "bg-gray";
										} ?>">
			...
			<div class="col-lg-2 col-xs-2">
				<div class="small-box <?php if (chk_array($this->parametros, 0) == 'adicionar') {
											echo "bg-gray";
										} elseif (chk_array($this->parametros, 0) == 'editar' && chk_array($this->parametros, 2) == 'telefones') {
											echo "bg-red";
										} else {
											echo "bg-gray";
										} ?>">
			...
			<div class="col-lg-2 col-xs-2">
				<div class="small-box <?php if (chk_array($this->parametros, 0) == 'adicionar') {
											echo "bg-gray";
										} elseif (chk_array($this->parametros, 0) == 'editar' && chk_array($this->parametros, 2) == 'arquivos') {
											echo "bg-red";
										} else {
											echo "bg-gray";
										} ?>">
