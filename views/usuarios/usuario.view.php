									...
									<div class="card-body">
										...
										<div class="form-group">
											...
											<select class="form-control" name="permissao" id="permissao" required>
												...
												<option <?php if(htmlentities(chk_array($registro, 'idPermissao')) == $dadosPermissoes['id']){ echo'selected'; } ?> value="<?php echo $dadosPermissoes['id']; ?>"><?php echo $dadosPermissoes['permissao']; ?></option>
												<?php endforeach; ?>
											</select>
										</div>
