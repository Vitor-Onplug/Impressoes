					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active"><a href="<?php echo HOME_URI; ?>/empresas/index/perfil/<?php echo chk_array($parametros, 1); ?>">Perfil</a></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<section class="content">
							<div class="card card-secondary">
								...
								<div class="card-footer">
									<a href="<?php echo HOME_URI; ?>/empresas/index/editar/<?php echo chk_array($parametros, 1); ?>/documentos" class="pull-right btn btn-sm btn-secondary">Editar</a>
								</div>
							</div>
						</section>
					</div>
					...
					<div class="col-md-6">
						<section class="content">
							<div class="card card-secondary">
								...
								<div class="card-footer">
									<a href="<?php echo HOME_URI; ?>/empresas/index/editar/<?php echo chk_array($parametros, 1); ?>/emails" class="pull-right btn btn-sm btn-secondary">Editar</a>
								</div>
							</div>
						</section>
					</div>
					...
					<div class="col-md-6">
						<section class="content">
							<div class="card card-secondary">
								...
								<div class="card-footer">
									<a href="<?php echo HOME_URI; ?>/empresas/index/editar/<?php echo chk_array($parametros, 1); ?>/telefones" class="pull-right btn btn-sm btn-secondary">Editar</a>
								</div>
							</div>
						</section>
					</div>
					...
					<div class="col-md-6">
						<section class="content">
							<div class="card card-secondary">
								...
								<div class="card-footer">
									<a href="<?php echo HOME_URI; ?>/empresas/index/editar/<?php echo chk_array($parametros, 1); ?>/arquivos" class="pull-right btn btn-sm btn-secondary">Gerenciar</a>
								</div>
							</div>
						</section>
					</div>
					...
					<div class="col-md-12">
						<section class="content">
							<div class="card card-secondary">
								...
								<div class="card-footer">
									<a href="<?php echo HOME_URI; ?>/empresas/index/editar/<?php echo chk_array($parametros, 1); ?>/enderecos/" class="pull-right btn btn-sm btn-secondary">Editar</a>
								</div>
							</div>
						</section>
					</div>
					...
					<div class="col-md-6">
						<section class="content">
							<div class="card card-secondary">
								...
								<div class="card-footer">
									<a href="<?php echo HOME_URI; ?>/empresas/index/editar/<?php echo chk_array($parametros, 1); ?>" class="btn btn-secondary">Editar</a>
								
									<?php if(chk_array($this->userdata, 'id') == chk_array($parametros, 1)){?>
									<a href="<?php echo HOME_URI; ?>/empresas/index/trocar-minha-senha" class="btn btn-secondary">Trocar Minha Senha</a>
									<?php } ?>
								</div>
							</div>
						</section>
